	...
	<body>
		<form id="Form1" method="post" runat="server">
			<table cellSpacing="0" borderColorDark="#9cc7ef" cellPadding="4" width="60%" align="center"
				...
				<tr bgColor="#4296e7">
					<td colSpan="2">
						<div align="center"><font color="#ffffff">添加作品</font></div>
					</td>
				</tr>
				<tr>
					<td noWrap width="30" style="WIDTH: 164px">
						<FONT face="宋体">作品名称:</FONT>
					</td>
					<td width="79%">
						<asp:textbox id="mc" runat="server" Width="304px"></asp:textbox></td>
				</tr>
				<TR>
					<TD style="WIDTH: 164px" noWrap width="164" height="25"><FONT face="宋体">作品类别:</FONT></TD>
					<TD width="59%" height="25">
						<asp:DropDownList id="lb" runat="server"></asp:DropDownList></TD>
				</TR>
				<TR>
					<TD style="WIDTH: 164px" noWrap width="164" height="25"><FONT face="宋体">作品图片:</FONT></TD>
					<TD width="59%" height="25"><INPUT id="UploadFile" type="file" size="50" name="UploadFile" runat="server"></TD>
				</TR>
				<TR>
					<TD style="WIDTH: 164px; HEIGHT: 72px" noWrap width="164" height="72"><FONT face="宋体">作品简介:</FONT></TD>

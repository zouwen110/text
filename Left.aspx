            ...
            <asp:TreeView ID="TreeView1" runat="server" ShowLines="True" ExpandDepth="1" Font-Bold="False"
                ...
                <Nodes>
                 ...
                 <asp:TreeNode Text="留言板管理" Value="留言板管理" SelectAction="Expand">
                        <asp:TreeNode NavigateUrl="lyb_gl.aspx" Target="main" Text="留言板管理" Value="留言板管理"></asp:TreeNode>
                </asp:TreeNode>
                  ...
                  <asp:TreeNode Text="日志管理" Value="日志管理" SelectAction="Expand">
                      <asp:TreeNode NavigateUrl="gg_add.aspx?lb=1" Target="main" Text="日志添加" Value="日志添加"></asp:TreeNode>
                      <asp:TreeNode NavigateUrl="gg_list.aspx?lb=1" Target="main" Text="日志管理" Value="日志管理"></asp:TreeNode>
                  </asp:TreeNode>
                  <asp:TreeNode Text="作品管理" Value="作品管理" SelectAction="Expand">
                      <asp:TreeNode NavigateUrl="pro_add.aspx" Target="main" Text="作品添加" Value="作品添加"></asp:TreeNode>
                      <asp:TreeNode NavigateUrl="pro_list.aspx" Target="main" Text="作品管理" Value="作品管理"></asp:TreeNode>
                  </asp:TreeNode>
                 <%-- <asp:TreeNode Text="每周时报" Value="每周时报 SelectAction="Expand">
                    ...
                    <asp:TreeNode Text="友情链接管理" Value="友情链接管理" SelectAction="Expand">
                        <asp:TreeNode NavigateUrl="yqlj_add.aspx" Target="main" Text="友情链接管理" Value="友情链接管理"></asp:TreeNode>
                        
                    </asp:TreeNode>
                     <asp:TreeNode Text="像册管理" Value="像册管理" SelectAction="Expand">
                        <asp:TreeNode NavigateUrl="xiangce_add.aspx" Target="main" Text="像册添加" Value="像册添加"></asp:TreeNode>
                         <asp:TreeNode NavigateUrl="xiangce_list.aspx" Target="main" Text="像册管理" Value="像册管理"></asp:TreeNode>
